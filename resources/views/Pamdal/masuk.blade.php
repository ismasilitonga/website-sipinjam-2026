...
<head>
    ...
    <title>Pamdal - Student Center Politeknik Negeri Batam</title>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="role-badge">
                <i class="fas fa-shield-halved"></i> Pamdal
            </div>
            <h2>Selamat Datang</h2>
            <p>Portal verifikasi check-in dan check-out penggunaan ruangan.</p>
        </div>
