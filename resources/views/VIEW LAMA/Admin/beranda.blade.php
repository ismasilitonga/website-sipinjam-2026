...
<head>
    ...
    <style>
        :root {
            ...
            /* Variabel untuk transparansi yang seragam */
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* --- WRAPPER UNTUK MENYATUKAN LATAR PUTIH --- */
        .main-content-glass {
        ...
        .feature-card {
            ...
            height: 300px;
            padding: 45px 30px;
            background: var(--white); /* Kolom kecil tetap putih solid sesuai permintaan */
...
<body>
    ...
    <nav class="navbar">
        <a href="{{ url('/') }}" class="nav-left">
         ...
         <div class="menu">
            ...
            <a href="{{ url('/Admin/panduan') }}">Panduan</a>
            <a href="{{ url('/Admin/masuk') }}">Masuk</a>
        </div>
    </nav>
    ...
    <div class="main-content-glass">
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <div>
                    <a href="{{ url('/Anggota/masuk') }}" class="btn btn-primary">Mulai Peminjaman</a>
                    <a href="{{ url('/panduan') }}" class="btn btn-secondary">Lihat Panduan</a>
                </div>
            </div>
        </section>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-box">
                <h4>Tautan Cepat</h4>
                <a href="{{ url('/Ketua/panduan') }}" class="footer-link">Panduan</a>
                <a href="{{ url('/Ketua/tentang') }}" class="footer-link">Tentang</a>
                <a href="{{ url('/Ketua/masuk') }}" class="footer-link">Masuk</a>
            </div>
            <div class="footer-box">
                <h4>Kontak</h4>
