    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .features-track {
            ...
            gap: 30px;
            width: max-content;
            animation: scroll-features 10s linear infinite; 
        }
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="menu">
            <a href="{{ url('/Pamdal/beranda') }}" class="active">Beranda</a>
            <a href="{{ url('/Pamdal/tentang') }}">Tentang</a>
            <a href="{{ url('/Pamdal/panduan') }}">Panduan</a>
            <a href="{{ url('/Pamdal/masuk') }}">Masuk</a>
        </div>
    </nav>
    ...
    <div class="main-content-glass">
        <section class="hero">
            <div class="hero-content">
                ...
                <p>Sistem manajemen keamanan dan verifikasi pengambilan kunci Student Center Politeknik Negeri Batam.</p>
                <div>
                    <a href="{{ url('/Pamdal/masuk') }}" class="btn btn-primary">Masuk Petugas</a>
                    <a href="{{ url('/Pamdal/panduan') }}" class="btn btn-secondary">Lihat Panduan</a>
                </div>
            </div>
        </section>
        ...
        <section class="features-section">
            <div class="section-title">
                ...
                <p>Sistem dirancang untuk membantu petugas keamanan dalam memonitor penggunaan sarana prasarana.</p>
            </div>
            ...
            <div class="features-container">
                <div class="features-track" id="featureTrack">
                    <div class="feature-card">
                        ...
                        <p>Pantau pengambilan dan pengembalian kunci ruangan secara digital.</p>
                    </div>

                    <div class="feature-card">
                        <div class="feature-icon"><i class="fas fa-location-dot"></i></div>
                        <h3>Verifikasi Check-In</h3>
                        <p>Validasi bukti kehadiran digital pengguna saat akan menggunakan ruangan.</p>
                    </div>

                    <div class="feature-card">
                        <div class="feature-icon"><i class="fas fa-chart-line"></i></div>
                        <h3>Monitoring Real-time</h3>
                        <p>Lihat status penggunaan seluruh ruangan Student Center secara langsung.</p>
                    </div>

                    <div class="feature-card">
                        <div class="feature-icon"><i class="fas fa-exclamation-circle"></i></div>
                        <h3>Laporan Insiden</h3>
                        <p>Pantau laporan kerusakan fasilitas untuk tindak lanjut keamanan.</p>
                    </div>
    ...
    <footer>
        <div class="footer-content">
            <div class="footer-box">
                <h4>Tentang Kami</h4>
                <p style="color: #cbd5e1;">Unit Student Center Politeknik Negeri Batam berdedikasi untuk memberikan layanan terbaik melalui koordinasi petugas keamanan.</p>
            </div>
            <div class="footer-box">
                <h4>Tautan Cepat</h4>
                <a href="{{ url('/Pamdal/panduan') }}" class="footer-link">Panduan</a>
                <a href="{{ url('/Pamdal/tentang') }}" class="footer-link">Tentang</a>
                <a href="{{ url('/Pamdal/masuk') }}" class="footer-link">Masuk</a>
            </div>
            <div class="footer-box">
                <h4>Kontak Keamanan</h4>
                <div class="footer-link">security@polibatam.ac.id</div>
