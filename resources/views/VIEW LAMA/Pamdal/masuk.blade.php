...
<head>
    ...
    <title>Halaman Masuk - Pamdal</title>
    <style>
    ...
    <div class="navbar">
        ...
        <div class="nav-right">
            <div class="menu">
                ...
                <a href="/Pamdal/tentang">Tentang</a>
                <a href="/Pamdal/Panduan">Panduan</a>
                <a href="/Pamdal/masuk" style="background: rgba(255,255,255,0.2);">Masuk</a>
            </div>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="login-container">
            <div class="login-box">
                ...
                <form action="/Pamdal/beranda" method="GET">
