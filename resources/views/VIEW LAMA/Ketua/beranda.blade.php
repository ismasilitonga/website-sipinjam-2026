...
<body>
    ...
    <div class="menu">
        ...
        <a href="{{ url('/Ketua/tentang') }}">Tentang</a>
        <a href="{{ url('/Ketua/panduan') }}">Panduan</a>
        <a href="{{ url('/Ketua/masuk') }}">Masuk</a>
    </div>
    </nav>
    ...
    <div class="main-content-glass">
        <section class="hero">
            <div class="hero-content">
                ...
                <div>
                    <a href="{{ url('/Ketua/masuk') }}" class="btn btn-primary">Mulai Peminjaman</a>
                    <a href="{{ url('/Ketua/panduan') }}" class="btn btn-secondary">Lihat Panduan</a>
                </div>
            </div>
        </section>
