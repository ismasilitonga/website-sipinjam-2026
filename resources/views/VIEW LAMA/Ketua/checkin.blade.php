...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .menu-title { padding: 12px 20px; font-weight: 580; display: flex; 
        ...
        .submenu a { display: block; padding: 10px 14px; text-decoration: none; 
            color: black; margin: 2px 0; border-radius: 6px; 
        ...
        h2 { font-size: 20px; font-weight: 700; 
            ...
            border-left: 5px solid #2f7ea1; padding-left: 15px; }
            ...
            <div class="card">
                ...
                <form id="checkinForm">
                    <div class="form-group">
                        ...
                        <select class="input-style" id="statusHadir">
