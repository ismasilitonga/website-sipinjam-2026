...
<head>
    ...
    <title>Riwayat Laporan - SC-Space</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .dropdown div { padding: 10px; cursor: pointer; display: flex; align-items: center; gap: 8px; color: #333; font-size: 14px; }
        ...
        .table-riwayat thead th { background: #abc7e4 !important; color: #334155; padding: 20px 15px; font-weight: 600; font-size: 15px; }
        .table-riwayat tbody td { padding: 22px 15px; font-size: 14px; color: #475569; background: white; border-bottom: 1px solid #f1f5f9; }

        .status-pill { padding: 6px 16px; border-radius: 20px; font-size: 12px; font-weight: 600; display: inline-flex; align-items: center; gap: 8px; }
        .status-pill::before { content: ""; width: 8px; height: 8px; border-radius: 50%; }
        .status-menunggu { background: #FFF3E0; color: #E65100; }
        .status-menunggu::before { background: #FF9800; }
        .status-proses { background: #E3F2FD; color: #0D47A1; }
        .status-proses::before { background: #2196F3; }
        .status-selesai { background: #E8F5E9; color: #1B5E20; }
        .status-selesai::before { background: #4CAF50; }
        .status-ditolak { background: #FFEBEE; color: #B71C1C; }
        .status-ditolak::before { background: #F44336; }
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endphp
                                <span class="status-pill {{ $class }}">{{ $s }}</span>
                            </td>
                            <td>
                                <a href="/Anggota/detaillaporan/{{ $laporan->id }}" class="btn-action-detail">Detail <i class="fa-solid fa-chevron-right"></i></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="5" style="padding: 80px 0; color: #94a3b8; font-style: italic;">
                                ...
                                Belum ada riwayat laporan insiden.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
