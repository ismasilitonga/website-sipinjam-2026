                ...
                <div class="form-group">
                    ...
                    <div class="select-container">
                        <div class="input-style" onclick="toggleDropdownBox(event)">
                            <span id="kondisiLabel">Pilih Kondisi Akhir</span>
                            <i class="fa-solid fa-chevron-down" style="font-size: 12px; color: #000;"></i>
                        </div>
                        <div class="dropdown-box" id="kondisiBox">
                            <div class="item-row" onclick="pickKondisi('Bersih & Rapi')">Bersih & Rapi</div>
                            <div class="item-row" onclick="pickKondisi('Perlu Pembersihan')">Perlu Pembersihan</div>
                            <div class="item-row" onclick="pickKondisi('Ada Fasilitas Rusak')">Ada Fasilitas Rusak</div>
                        </div>
                        <input type="hidden" id="kondisiInput" name="kondisi_akhir" required>
                    </div>
                </div>
...
<script>
    ...
    function toggleDropdownBox(e) {
        e.stopPropagation();
        const box = document.getElementById('kondisiBox');
        box.classList.toggle('show');
    }

    function pickKondisi(val) {
        document.getElementById('kondisiLabel').innerText = val;
        document.getElementById('kondisiLabel').style.color = "#333";
        document.getElementById('kondisiInput').value = val;
        document.getElementById('kondisiBox').classList.remove('show');
    }
    ...
    function validateAndShow() {
        const kondisi = document.getElementById('kondisiInput').value;
        if(!kondisi) { 
