...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="{{ url('/Anggota/tentang') }}">Tentang</a>
        <a href="{{ url('/Anggota/panduan') }}">Panduan</a>
        <a href="{{ url('/Anggota/masuk') }}">Masuk</a>
    </div>
</nav>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-box">
                <h4>Tautan Cepat</h4>
                <a href="{{ url('/panduan') }}" class="footer-link">Panduan</a>
                <a href="{{ url('/Anggota/tentang') }}" class="footer-link">Tentang</a>
                <a href="{{ url('/Anggota/masuk') }}" class="footer-link">Masuk</a>
            </div>
            <div class="footer-box">
                <h4>Kontak</h4>
