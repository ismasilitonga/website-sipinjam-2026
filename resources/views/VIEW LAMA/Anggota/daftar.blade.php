...
<head>
    ...
    <title>Daftar Akun - SC-Space</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Gaya Teks Logo SC-Space Mengkilap & Gemuk */
        .brand-text {
            font-size: 22px;
            font-weight: 800; /* Dibuat gemuk sesuai beranda */
        ...
        /* UKURAN KOLOM TETAP TINGGI DAN BERISI (1rem 1.2rem) */
        input, select { 
            width: 100%; padding: 1rem 1rem 1rem 1.2rem; 
...
<body>
    <div class="navbar">
        ...
        <div class="nav-right">
            <div class="menu">
                ...
                <a href="/Anggota/daftar" class="active">Daftar</a>
            </div>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="register-container">
            <div class="register-box">
                ...
                <form id="registerForm" method="POST" action="/Anggota/daftar">
                    @csrf 
                    ...
                    <div class="input-group">
                        <input type="text" id="nim" name="nim" placeholder="NIM" value="{{ old('nim') }}" inputmode="numeric" pattern="\d{10}" maxlength="10" required>
                    </div>
                    <div class="input-group">
    ...
    <script>
        ...
        document.getElementById('eyePassword').addEventListener('click', () => togglePassword('password', 'eyePassword'));
        document.getElementById('eyeConfirm').addEventListener('click', () => togglePassword('confirm', 'eyeConfirm'));
        ...
        document.getElementById('registerForm').addEventListener('submit', function(e) {
            ...
            if (nim.length !== 10) {
                alert("NIM harus tepat 10 digit angka!");
                e.preventDefault();
