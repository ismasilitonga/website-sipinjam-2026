...
<body>
    <div class="navbar">
        ...
        <div class="nav-right">
            <div class="menu">
                <a href="/Pic/beranda">Beranda</a>
                <a href="/Pic/tentang">Tentang</a>
                <a href="/Pic/panduan">Panduan</a>
                <a href="/Pic/daftar" style="background: rgba(255,255,255,0.2);">Daftar</a>
            </div>
        </div>
    </div>
                ...
                <form id="registerForm" method="POST" action="/Anggota/daftar">
                    ...
                    <div class="input-group">
                        <input type="text" 
                               ...
                               inputmode="numeric"
                               pattern="\d{10}" 
                               title="NIM harus berupa 10 digit angka" 
                               minlength="10" 
                               maxlength="10" 
                               required>
                    </div>
