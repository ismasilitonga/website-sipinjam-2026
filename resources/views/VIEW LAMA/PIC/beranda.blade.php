...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="menu">
            ...
            <a href="{{ url('/Pic/tentang') }}">Tentang</a>
            <a href="{{ url('/Pic/panduan') }}">Panduan</a>
            <a href="{{ url('/Pic/masuk') }}">Masuk</a>
        </div>
    </nav>
    ...
    <div class="main-content-glass">
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <div>
                    <a href="{{ url('/Pic/masuk') }}" class="btn btn-primary">Mulai Peminjaman</a>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-box">
                <h4>Tautan Cepat</h4>
                <a href="{{ url('/Pic/panduan') }}" class="footer-link">Panduan</a>
                <a href="{{ url('/Pic/tentang') }}" class="footer-link">Tentang</a>
                <a href="{{ url('/Pic/masuk') }}" class="footer-link">Masuk</a>
            </div>
            <div class="footer-box">
                <h4>Kontak</h4>
