...
<div class="alert alert-info" style="margin-top:16px;">
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"
         style="width:17px;height:17px;flex-shrink:0;margin-top:2px;">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
    </svg>

    <div style="font-size:14px; line-height:1.6;">
        Setelah <strong>check-in</strong>, pastikan kamu juga melakukan
        <strong>check-out</strong> setelah selesai menggunakan ruangan.
        Petugas Pamdal akan mengonfirmasi pengambilan dan pengembalian kunci.
    </div>
</div>
