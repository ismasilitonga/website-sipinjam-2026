...
<div class="card">
    ...
    <form method="GET"
        ...
        @if(request('search') || request('sumber') || request('jenis'))
            <a href="{{ route('pic.barang.index') }}" class="btn btn-outline">Reset</a>
        @endif
    </form>
        ...
        <table style="width:100%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if(str_starts_with($b->kode, 'SC-'))
                            <span class="badge badge-blue">PIC</span>
                        @else
                            <span class="badge badge-purple">Ormawa</span>
                        @endif
                    </td>
                    ...
                    <td>
                        <span class="badge {{ ($b->jenis_barang ?? 'bisa_dipinjam') === 'arsip' ? 'badge-gray' : 'badge-blue' }}">
                            {{ ($b->jenis_barang ?? 'bisa_dipinjam') === 'arsip' ? 'Arsip' : 'Bisa Dipinjam' }}
                        </span>
                    </td>

                    <td>
                        <div style="display:flex;gap:6px;">
                            <a href="{{ route('pic.barang.edit', $b->id) }}" class="btn btn-outline btn-sm">Edit</a>
                ...
                <tr>
                    <td colspan="11">
                        <div class="empty-state">
                            ...
                            <p>
                                Belum ada barang.
                                <a href="{{ route('pic.barang.create') }}" style="color:var(--accent);">
                                    Tambah sekarang →
                                </a>
                            </p>
                        </div>
