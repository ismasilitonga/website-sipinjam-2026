...
@section('topbar-action')
   <a href="{{ route('ketua.barang-ormawa.create') }}" class="btn btn-primary">
...
@if(session('success'))
    <div class="alert alert-success" style="
        ...
        display:flex;align-items:center;gap:8px;font-size:13px;color:#166534;">
...
<div style="
    ...
    display:flex;align-items:flex-start;gap:9px;font-size:12.5px;color:#4c1d95;">
    ...
    <span>
        Barang yang kamu tambah di sini akan masuk ke halaman <strong>Kelola Barang</strong> PIC
        dan dapat dilihat oleh seluruh pengguna sebagai katalog.
...
<div class="card">
    <div class="card-header" style="padding-bottom:14px;display:flex;align-items:center;justify-content:space-between;">
        ...
        <div style="display:flex;gap:6px;align-items:center;">
            <span style="font-size:11px;padding:3px 9px;border-radius:12px;background:#eeedfe;color:#534ab7;font-weight:500;">
                ● Milik Ormawa
            </span>
            <span style="font-size:11px;padding:3px 9px;border-radius:12px;background:#e6f1fb;color:#185fa5;font-weight:500;">
                ● Dari PIC
            </span>
        </div>
    </div>
    ...
    <form method="GET"
      action="{{ route('ketua.barang-ormawa.index') }}"
      style="
        padding:16px;
        display:flex;
        gap:10px;
    ...
    <div class="table-wrap" style="overflow-x:auto;">
        <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td>
                        @if($isOrmawa)
                            <span style="font-size:11px;padding:3px 8px;border-radius:10px;
                                         background:#eeedfe;color:#534ab7;font-weight:500;">
                                Ormawa
                            </span>
                        @else
                            <span style="font-size:11px;padding:3px 8px;border-radius:10px;
                    ...
                    <td>
                        <div style="display:flex;gap:6px;">
                                @if($isOrmawa)
                        <a href="{{ route('ketua.barang-ormawa.edit', $b->id) }}"
                        class="btn btn-warning btn-sm">
                        Edit
                        </a>
                              
                                <form method="POST"
                                      action="{{ route('ketua.barang-ormawa.destroy', $b->id) }}">
                                    @csrf @method('DELETE')
            ...
            @if($search || $sumber)
                ...
                <a href="{{ route('ketua.barang-ormawa.index') }}"
                style="color:var(--accent);"> Tampilkan semua →</a>
            @else

                <p>
                    Belum ada barang ormawa.

                    <a href="{{ route('ketua.barang-ormawa.create') }}"
