...
<body>
    <div class="navbar">
        ...
        <div class="nav-right">
            <div class="menu">
                ...
                <a href="/Ketua/daftar" style="background: rgba(255,255,255,0.2);">Daftar</a>
            </div>
        </div>
    </div>
    <div class="main-content">
        <div class="register-container">
            <div class="register-box">
                ...
                <form id="registerForm" method="POST" action="/Ketua/daftar">
                    @csrf 
    ...
    <select name="organisasi" required>
        ...
        @foreach($ormawas as $ormawa)
            <option value="{{ $ormawa->singkatan }}"
                {{ old('organisasi') == $ormawa->singkatan ? 'selected' : '' }}>
                {{ $ormawa->singkatan }}
            </option>
        @endforeach
    </select>
                    ...
                    <div class="input-group">
                        <input type="text" id="nim" name="nim" placeholder="NIM" value="{{ old('nim') }}" maxlength="10" required>
                    </div>
                    <div class="input-group">
...
<div class="input-group password-group">
    <input type="password" id="confirm" name="password_confirmation" placeholder="Konfirmasi Kata Sandi" required>
