...
<head>
    ...
    <title>Ketua Ormawa - Student Center Politeknik Negeri Batam</title>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="role-badge">
                <i class="fas fa-user-tie"></i> Ketua Ormawa
            </div>
            <h2>Selamat Datang</h2>
            <p>Portal persetujuan internal dan manajemen anggota ormawa.</p>
        </div>
