...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sidebar-user-role { font-size: 10px; color: #f87171; line-height: 1.3; }
        ...
        .kunci-flow { display: flex; align-items: center; gap: 6px; font-size: 12px; }
        .kunci-step { display: flex; align-items: center; gap: 4px; padding: 2px 9px; border-radius: 999px; font-weight: 600; }
        .kunci-step svg { width: 12px; height: 12px; }
        .kunci-step-done    { background: #dcfce7; color: #15803d; }
        .kunci-step-pending { background: #f4f4f5; color: #a1a1aa; }
        .kunci-arrow        { color: #d4d4d8; font-size: 13px; }
        ...
        .detail-row { display: flex; border-bottom: 1px solid var(--border); flex-wrap: wrap; }
        ...
        .item-card-title { font-family: 'Outfit', sans-serif; font-size: 13px; font-weight: 700; margin-bottom: 4px; }
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section-label">Kunci Ruangan</div>
