...
return new class extends Migration {
    ...
    {
        Schema::create('pengalihan_barangs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('peminjaman_barang_id')->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('pengalihan_barangs');
    }
};
