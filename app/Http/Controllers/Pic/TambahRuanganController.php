...
class TambahRuanganController extends Controller
    ...
    return view('pic.ruangan.index', compact('ruangans'));
    }

    public function create()
    {
        return view('pic.ruangan.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pic.ruangan.index')->with('success', 'Ruangan berhasil ditambahkan.');
    }

    public function edit($id)
    {
        $ruangan = Ruangan::findOrFail($id);
        return view('pic.ruangan.edit', compact('ruangan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $ruangan->update($data);
        return redirect()->route('pic.ruangan.index')->with('success', 'Ruangan berhasil diperbarui.');
    }
